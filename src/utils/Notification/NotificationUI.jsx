...
const NotificationUI = ({ type, title, description, onClose, keyPage }) => {
    ...
    return (
        <div className={`notification notification__${type} ${keyPage} ${fadeOut ? 'fade-out' : 'fade-in'}`}>
            <div className={`notification__left`}>
                {
                    type === 'success'
                        ...
                        : <FontAwesomeIcon icon={faCircleExclamation} className={`notification__icon__${type}`}></FontAwesomeIcon>
                }
            ...
            <FontAwesomeIcon icon={faXmark} className={`notification__icon__${type}`} onClick={onClose}></FontAwesomeIcon>
        </div>
    );
};
