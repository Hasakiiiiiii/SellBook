...
import { getVouchersByCuaHangIdAndVoucherID, addVoucher, updateVoucherByID } from "../../utils/API/VoucherAPI";

const VoucherForm = ({ keyForm, onClose, onApply, voucherID, nameShop }) => {
    ...
    const handleInputChange = (e) => {
        ...
        let newValue = value;
        let newErrors = { ...errors }; // Sao chép trạng thái lỗi hiện tại

        // Chỉ cho phép nhập số với các trường 'giam_gia' và 'gia_ap_dung'
        if (id === 'giam_gia' || id === 'gia_ap_dung') {
            ...
            <div className="bg_black">
                <div className='voucher-form'>
                    <div className='voucher-form_info'>
                        ...
                        <p className='voucher-form_info--if2'>{'>=' + voucher.gia_ap_dung}</p>
                    ...
                    <div className="voucher-info">
                        ...
                        <form className="voucher-info_form">
                            ...
                            <div className="voucher-info_form--item item-update">
                                <div>
                                    <label htmlFor="gia_ap_dung">Điều kiện sử dụng ( giá tối thiểu )</label>
                                    <input
                                        className={errors.gia_ap_dung ? 'bd_error' : ''}
                                        onChange={handleInputChange}
                                        onBlur={handleInputBlur}
                                        value={voucher.gia_ap_dung}
                                        id="gia_ap_dung" type="text" placeholder='VD: áp dụng với đơn hàng >= 100k' />
