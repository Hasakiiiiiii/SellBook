                    ...
                    <div className={styles.wallet} >
                        ...
                        {user && (
                            <div className={styles.walletInfo}>
                                <FontAwesomeIcon icon={faWallet} /> Ví:{walletBalance.toLocaleString()} đ
                            </div>
                        )}
                    </div>
                                ...
                                >
                                    ...
                                    {isDropdownOpen && (
                                        <div className={styles.dropdownMenu}>
                                            ...
                                            <Link to='/seller'>Đăng kí trở thành người bán</Link>
                                            <Link to='/HomeUser'><span onClick={handleLogout}>Đăng xuất</span></Link>
                                        </div>
                                    )}
                                </div>
                            ) : (
                                ...
                                >
                                    ...
                                    <div className={styles.cartItemInfo}>
                                        ...
                                        <p className={styles.cartItemPrice}>
                                            {item.gia.toLocaleString('vi-VN')} đ x {item.so_luong}
                                        </p>
                                    </div>
                                </div>
                            ))
